...
public class ModBlockMulti extends ModBlock implements IBlockMulti{

	protected String[] subNames;
	protected IIcon[] icons;
	public ModBlockMulti(Material mat, CreativeTabs tab, String mod, String unlocName, String ... subNames) {
