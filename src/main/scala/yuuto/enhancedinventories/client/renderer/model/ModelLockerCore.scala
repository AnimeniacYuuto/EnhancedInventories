...
class ModelLockerCore extends ModelIconCube{
  ...
  def drawLockerCore(icons:Array[IIcon], tess:Tessellator){
    this.setSide();
    this.drawCubeFromIcons(icons, tess, 0.001f, 0.001f, 0.001f, 1.5f/16f-0.001f, 0.999f, 0.999f, 
        0f, 0f, 0f, 1f, 1f, 1f);
    this.drawCubeFromIcons(icons, tess, 1.001f-(1.5f/16f), 0.001f, 0.001f, 0.999f, 0.999f, 0.999f, 
        0f, 0f, 0f, 1f, 1f, 1f);
    this.setTop();
    this.drawCubeFromIcons(icons, tess, 0.001f, 0.001f, 0.001f, 0.990f, 1.5f/16f-0.001f, 0.999f, 
        0f, 0f, 0f, 1f, 1f, 1f);
    this.drawCubeFromIcons(icons, tess, 0.001f, 1.001f-(1.5f/16f), 0.001f, 0.990f, 0.999f, 0.999f, 
        0f, 0f, 0f, 1f, 1f, 1f);
    this.setFront();
    this.drawCubeFromIcons(icons, tess, 0.001f, 0.001f, 1.001f-(1.5f/16f), 0.990f, 0.999f, 0.999f, 
        0f, 0f, 0f, 1f, 1f, 1f);
    GL11.glPushMatrix();
    if(reversed)
  ...
  def drawDoor(icons:Array[IIcon], tess:Tessellator){
    ...
    this.drawCubeFromIcons(icons, tess, -(1-(3.5f/16f)), 0.001f+(1.5f/16f), 0.001f, 0, 1.001f-(1.5f/16f), 0.001f+0.5f/16f, 
        0f, 0f, 0f, 1f, 1f, 1f);
  }
  def drawDoorReversed(icons:Array[IIcon], tess:Tessellator){
    GL11.glTranslatef((1.5f/16f), 0, 1.5F/16F);
    GL11.glRotatef(-rotaionAngle, 0, 1, 0);
    this.drawCubeFromIcons(icons, tess, 0.001f, 0.001f+(1.5f/16f), 0.001f, (1-(3.5f/16f)), 1.001f-(1.5f/16f), 0.001f+0.5f/16f, 
        0f, 0f, 0f, 1f, 1f, 1f);
  }
